...
class App extends Component {
	...
	render() { 
		return (
			<React.Fragment>
				<svg id="random" xmlns="http://www.w4.org/2000/svg" viewBox="0 0 96.32 91.08" width="100px" height="100px" onClick={this.randomPage}>
				...
				<svg id="magglass" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 31.78 30.3" width="70px" height="40px" onClick={this.showSearch}>
					<circle cx="13.81" cy="13.81" r="12.31" style={{fill:"none", stroke:"#fff200", strokeMiterlimit:10, strokeWidth:"3px"}}/>
					<line id="handle" x1="23.35" y1="21.63" x2="30.7" y2="29.26" style={{stroke:"#fff200", strokeMiterlimit:10, strokeWidth:"3px"}}/>
				...
				<form style={{display: this.state.show}} onSubmit={this.updateResults}>
					<input type="text" value={this.state.search} onChange={this.updateSearch}/>
				</form>
				<ul>{this.state.results.map(([title, extract, pageid]) => <li key={pageid}><a href={"https://en.wikipedia.org/?curid=" + pageid} target="_blank">{title + '--' + extract}</a></li>)}</ul>
			</React.Fragment>
		);
	}
}
